...
import { fetchFeaturedProperties } from "@/utils/actions";

async function FeaturedProperties() {
  const properties = await fetchFeaturedProperties();
  return (
    <section className="my-8 bg-muted p-6">
      <h2 className="text-3xl text-center mb-1 font-semibold">
        Featured Properties
      </h2>

      <div className="gap-4 grid grid-cols-1 sm:grid-cols-2  lg:grid-cols-3 py-3 ">
